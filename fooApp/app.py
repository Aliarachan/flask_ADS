...
app.config['MONGO_URI'] = 'mongodb+srv://dbUser:d6mlzUhBocV2DE8S@cluster0-964qd.mongodb.net/test'
...
def product_edit(product_id):
  ...
  form = ProductForm(request.form, name=product['name'], description=product['description'], price=product['price'])
